...
describe('SpaceAge', () => {
  ...
  test('it returns number of mercury years between earth age and future birthday', () => {
    const spaceAge = new SpaceAge();
    spaceAge.changeCurrentPlanet("mercury")
    spaceAge.setEarthAge(33);
    expect(spaceAge.yearsUntilBirthday(42)).toEqual(9 / .24);
  });

  test('it returns number of venus years between earth age and future birthday', () => {
    const spaceAge = new SpaceAge();
    spaceAge.changeCurrentPlanet("venus")
    spaceAge.setEarthAge(33);
    expect(spaceAge.yearsUntilBirthday(42)).toEqual(9 / .62);
  });

  test('it returns number of mars years between earth age and future birthday', () => {
    const spaceAge = new SpaceAge();
    spaceAge.changeCurrentPlanet("mars")
    spaceAge.setEarthAge(33);
  ...
  test('it returns error message for unrecognized planet', () => {
    ...
    spaceAge.changeCurrentPlanet("pluto");
    spaceAge.setEarthAge(33);
    expect(spaceAge.yearsUntilBirthday()).toEqual("that planet isn't in this solar system");
  });
});